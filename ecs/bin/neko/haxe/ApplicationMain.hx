...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ECSDemo", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("ECSDemo", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "3";
		app.meta["company"] = "Gemini";
		app.meta["file"] = "ECSDemo";
		app.meta["name"] = "HaxeFlixel ECS Demo";
		app.meta["packageName"] = "com.example.ecstest";
		...
		#elseif air
		app.window.title = "HaxeFlixel ECS Demo";
		#else
